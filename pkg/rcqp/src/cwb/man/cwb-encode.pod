...
character set to I<ascii>, or even remove the default altogether (so that specifying a character set explicitly will be
...
XML attribute-value pairs can be auto-split and indexed as separate s-attribute. In this case, you should append
...
L<cwb-config>, L<cwb-decode-nqrfile>, L<cwb-decode>, L<cwb-describe-corpus>, L<cwb-huffcode>, 
