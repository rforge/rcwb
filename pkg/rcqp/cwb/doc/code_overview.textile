...
h4. cqp/paths.c ; cqp/paths.h

* contains just one function, @get_path_component()@ . This breaks apart a string of:words:linked:like:this and returns them in l-to-r order, one by one on repeated calls.
